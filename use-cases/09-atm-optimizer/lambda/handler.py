"""
ATM Optimizer AI Agent — Async Lambda Proxy
...
# ── Config ──
AGENT_ARN = os.environ.get("ATM_AGENT_ARN", "arn:aws:bedrock-agentcore:eu-west-1:519124228967:runtime/neobank_atm_optimizer-kd3eDM3jHq")
SESSION_TABLE = os.environ.get("SESSION_TABLE", "aibank-session-routing")
ATM_RESULTS_TABLE = os.environ.get("ATM_RESULTS_TABLE", "aibank-atm-async-results")
ALLOWED_ORIGIN = os.environ.get("ALLOWED_ORIGIN", "https://aibank.demoaws.com")
ALLOWED_ROLES = ("operations", "operations-managers", "admin")

ddb = boto3.resource("dynamodb", region_name="eu-west-1")
agentcore = boto3.client("bedrock-agentcore", region_name="eu-west-1")
session_table = ddb.Table(SESSION_TABLE)
results_table = ddb.Table(ATM_RESULTS_TABLE)
